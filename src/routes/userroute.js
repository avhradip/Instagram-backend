...
const { register, login, getProfile, getSuggestedUsers, editProfile, followOrUnfollow, getUserProfile, getFollowers, getFollowing, removeFollower, forgotPassword } = require("../controllers/usercontroller")
